...
@CucumberOptions(features = "classpath:Features", // Feature tells cucumber where feature files are stored
		glue = { "stepDefinitions" }, // glue tells cucumber options where all Step Definitions class are stored
		tags = { "@sqlquery" }, // we can run all scenario or one scenario with help of tags
